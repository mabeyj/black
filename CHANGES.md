...
- Based on Black [21.12b0](#2112b0). (#2, #4)
...
- Add `--prefer-no-split-subscripts` to prefer wrapping with optional parentheses over
  splitting list/dictionary subscripts into multiple lines in assignment statements.
  (#6)
